...
def main():
    ...
    parser.add_argument("--input-dir", "--input_dir", dest="input_dir", required=True, help="Input JSON directory")
    parser.add_argument("--output-dir", "--output_dir", dest="output_dir", required=True, help="Output image directory")
    parser.add_argument("--cache-dir", "--cache_dir", dest="cache_dir", help="Cache directory")
    parser.add_argument("--batch-size", "--batch_size", dest="batch_size", type=int, default=1, help="Batch size")
    parser.add_argument("--seed", type=int, default=42, help="Random seed")
    parser.add_argument("--log-level", "--log_level", dest="log_level", default="INFO", help="Log level")
    parser.add_argument("--skip-files", "--skip_files", dest="skip_files", type=int, default=0, help="Skip first N files (for chunked processing)")
    parser.add_argument("--max-files", "--max_files", dest="max_files", type=int, default=None, help="Process at most N files (for chunked processing)")
    parser.add_argument("--model", default=None, help="Compatibility flag; current release always uses Qwen-Image")
    
    args = parser.parse_args()
    
    if args.model:
        print(f"[INFO] Ignoring --model={args.model}; this release currently loads Qwen/Qwen-Image.")
